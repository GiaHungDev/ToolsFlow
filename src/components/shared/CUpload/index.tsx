...
const FileUploadComponent: React.FC<FileUploadProps> = ({
    ...
    return (
        <div className={`w-full space-y-4 ${className}`}>
            ...
            <div
                className={`border-2 border-dashed rounded-lg p-4 sm:p-6 text-center transition-all duration-200 ${disabled ? "cursor-not-allowed opacity-50" : "cursor-pointer"
                    } ${isDragOver && !disabled
            ...
            >
                <div className="flex flex-col items-center space-y-2">
                    <div
                        className={`w-6 h-6 sm:w-8 sm:h-8 rounded-lg flex items-center justify-center ${disabled ? "bg-gray-100" : "bg-blue-100"
                            }`}
                    >
                        <Upload
                            className={`w-4 h-4 sm:w-6 sm:h-6 ${disabled ? "text-gray-400" : "text-blue-500"
                                }`}
                        />
                    </div>
                    ...
                    <div className="space-y-1">
                        <h6
                            className={`text-sm sm:text-base font-medium ${disabled ? "text-gray-400" : "text-gray-700"
                                } px-2 sm:px-0`}
                        >
                            {title}
                        </h6>
                        ...
                        <p
                            className={`text-xs ${disabled ? "text-gray-300" : "text-gray-400"
                                } px-2 sm:px-0`}
                        >
                            {supportText}
                        </p>
