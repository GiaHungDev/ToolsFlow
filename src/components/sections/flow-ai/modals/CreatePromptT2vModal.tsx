...
import { useCreatePromptT2V } from "@/hooks/flow-ai/useCreatePromptT2V";
...
const CreatePromptT2VModal: React.FC<CreatePromptT2VProp> = ({
  ...
  const { handleSubmit, loadFlow } = useCreatePromptT2V(
    onCancel,
    formPromptT2V,
    handleOpenListPromptModal
  );
        ...
        footer={
          <>
            <Button
              variant="secondary"
              onClick={onCancel}
              disabled={loadFlow.loadcreatePromptT2V}
            >
              Cancel
            </Button>
            <Button
              onClick={handleSubmit}
              loading={loadFlow.loadcreatePromptT2V}
              disabled={loadFlow.loadcreatePromptT2V}
