...
const CreateTopicT2VModal: React.FC<CreateTopicT2VProp> = ({
  ...
  const adjustTime = (field: "songMinutes" | "songSeconds", amount: number) => {
    setFormData((prev) => {
      ...
      if (field === "songMinutes") {
        ...
        if (newVal < 0) newVal = 0; // Hoặc 59 nếu muốn xoay vòng
        if (newVal > 59) newVal = 59; // Hoặc 0 nếu muốn xoay vòng
      }
  ...
  return (
    ...
    >
      {/* ✅ MODAL CHỨA TOÀN BỘ DASHBOARD */}
      <div className="font-sans text-sm text-stone-600 flex-1 overflow-y-auto bg-stone-50">
            ...
            <div className="flex p-1.5 bg-white rounded-full border-2 border-white shadow-md self-center xl:self-auto">
              <button
                ...
                className={`px-6 py-2.5 rounded-full font-bold transition text-xs uppercase tracking-wide ${
                  videoType === "story"
                    ? "bg-pink-500 text-white shadow-lg" // Sửa bg-cute-pink thành bg-pink-500
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4">
                    <div>
                      ...
                      <select
                        ...
                        onChange={handleInputChange}
                        className="w-full p-3 text-sm focus:border-cute-pink border-2 border-cute-mint/30 bg-cute-cream"
                      >
                  ...
                  <div className="flex gap-2">
                    <div className="relative flex-1 group">
                      <input
                        ...
                        min="0"
                        max="15"
                        className="w-full bg-cute-cream border-2 border-cute-mint/30 rounded-2xl p-3 text-center font-black text-xl text-stone-700 focus:border-cute-pink transition"
                        placeholder="0"
                      />
                      <span className="absolute right-3 top-4 text-stone-400 text-[9px] uppercase font-bold">
                        Phút
                      </span>
                    </div>
                    <div className="relative flex-1 group">
  ...
  <div className="flex gap-2 mt-5">
    ...
    <div className="relative flex-1 group">
      ...
      <span className="absolute -top-4 right-2 text-stone-400 text-[12px] uppercase font-bold">
        Phút
      </span>
    </div>
                  ...
                  <div className="flex gap-4 mt-5">
                    ...
                    <div className="relative flex-1 group">
                      ...
                      <input
                        ...
                        min="0"
                        max="15"
                        // Thêm px-12 để text không bị nút che
                    ...
                    <div className="relative flex-1 group">
                      {/* Nút TRỪ */}
                      <button
                        onClick={() => adjustTime("songSeconds", -10)} // Giảm 10s cho nhanh, hoặc -1 tùy bạn
                        className="absolute left-2 top-1/2 -translate-y-1/2 w-8 h-8 flex items-center justify-center bg-white rounded-full shadow-sm text-stone-400 hover:bg-rose-100 hover:text-rose-500 transition border border-stone-100 font-bold z-10"
                      >
                        -
                      </button>
                      ...
                      {/* Nút CỘNG */}
                      <button
                        onClick={() => adjustTime("songSeconds", 10)} // Tăng 10s cho nhanh
                        className="absolute right-2 top-1/2 -translate-y-1/2 w-8 h-8 flex items-center justify-center bg-white rounded-full shadow-sm text-stone-400 hover:bg-emerald-100 hover:text-emerald-500 transition border border-stone-100 font-bold z-10"
                      >
                        +
                      </button>
                ...
                <div className="mb-5">
                  ...
                  <div className="relative">
                    <select
                      ...
                      onChange={handleInputChange}
                      // Thêm appearance-none, pr-10 và cursor-pointer
                    ...
                    {/* Mũi tên tùy chỉnh nằm bên phải */}
                    <div className="absolute right-4 top-1/2 -translate-y-1/2 pointer-events-none text-stone-400">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        fill="none"
