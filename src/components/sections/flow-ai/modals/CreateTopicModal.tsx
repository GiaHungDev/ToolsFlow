...
import { useCreateTopic } from "@/hooks/flow-ai/useCreateTopic";
...
const CreateTopicModal: React.FC<ICreateTopic> = ({
  ...
  const { formTopic, handleSubmit, loadFlow } = useCreateTopic({
    formPrompt,
    onCancel,
    handleOpenPromptModal,
    handleSetTopic,
  ...
  return (
    <CDialog
      ...
      footer={
        <>
          <Button variant="secondary" onClick={onCancel} disabled={loadFlow.loadCreateTopic}>
            Cancel
          </Button>
          <Button
