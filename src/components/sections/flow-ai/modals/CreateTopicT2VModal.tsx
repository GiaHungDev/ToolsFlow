...
import { useCreateTopicT2V } from "@/hooks/flow-ai/useCreateTopicT2V";
import { PromptT2VFormValues } from "@/hooks/flow-ai/useFormPromptT2V";
...
const CreateTopicT2VModal: React.FC<CreateTopicT2VProp> = ({
  ...
  const { formTopicT2V, handleSubmit, loadFlow } = useCreateTopicT2V(
    formPromptT2V,
    onCancelTopicT2V,
    handleOpenT2VPromptModal,
    handleSetTopic,
      ...
      footer={
        <>
          <Button
            ...
            disabled={loadFlow.loadCreateTopic}
          >
            Cancel
          </Button>
          <Button
            ...
            loading={loadFlow.loadCreateTopic}
          >
